...
```bash
git clone https://github.com/VictorSuarezVara/Reading-analog_clocks-with-neural-networks.git
```
...
```bash
ls Reading-analog_clocks-with-neural-networks/Dataset\ of\ Clocks\ Generators/
```
...
sys.path.insert(0, str(Path("Reading-analog_clocks-with-neural-networks/Dataset of Clocks Generators")))
...
```python
# In config.py
REFERENCE_REPO_PATH = "./Reading-analog_clocks-with-neural-networks"
```
...
- **Reference Repository**: https://github.com/VictorSuarezVara/Reading-analog_clocks-with-neural-networks
